...
public class ViewDoctorFrame extends javax.swing.JFrame {
    ...
    public ViewDoctorFrame() {
       ...
       setTitle("Sanjeevani App View Doctors Screen");
    ...
    private void initComponents() {
        ...
        jtDocData.setBackground(new java.awt.Color(0, 102, 255));
        jtDocData.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jtDocData.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "USER ID", "DOCTOR ID", "QUALIFICATION", "SPECIALIST"
            }
        ) {
    ...
    private void showDocData(){
        try{
            ArrayList<DoctorPojo> docList=DoctorDao.getAllDoc();
             Object rows[]=new Object[4];
             DefaultTableModel dtm=(DefaultTableModel)jtDocData.getModel();
             for(DoctorPojo D:docList){
                rows[0]=D.getUserid();
                rows[1]=D.getDocid();
                rows[2]=D.getQualification();
                rows[3]=D.getSpecilist();
                dtm.addRow(rows); 
             }
        }
