...
public class UpdatePatientFrame extends javax.swing.JFrame {
    ...
    public boolean validateInput(){
        ...
        date=patient.get(jcbPID.getSelectedItem().toString()).getPdate();
        //date=new java.sql.Date(d.getTime());
        if(f_name.isEmpty()||s_name.isEmpty()||age==0||opd.isEmpty()||address.isEmpty()||city.isEmpty()||mno.isEmpty()||txtDate.getText().isEmpty())
            return false;
        return true;
    }
    ...
    PatientPojo pp=new PatientPojo(p_id,f_name,s_name,age,opd,gender,m_status,date,address,city,mno,doctor_id);
                try{
                    ...
                    if(result){
                        JOptionPane.showMessageDialog(null,"Success!","Record Updated Successfully",JOptionPane.INFORMATION_MESSAGE);
